...
################################################################################
## Form generated from reading UI file 'left_columnQfIrIe.ui'
##
...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.save_location_layout = QVBoxLayout()
        self.save_location_layout.setObjectName(u"save_location_layout")

        self.verticalLayout.addLayout(self.save_location_layout)
